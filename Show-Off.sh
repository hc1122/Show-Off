...
echo "";
echo -e "\e[1;34m[*] \e[32minstall ho rhe he packages wait kr chup chap....\e[0m";
echo "";
...
if [ -e $PREFIX/share/figlet/Remo773.flf ]; then
	echo -e "\e[1;34m[*] \033[32mHimmat Choudhary.flf figlet font is present\033[0m";
	sleep 4
else
...
do
	echo ""
tput setaf 3
read -p "Nam Dal Be Tera : " PROC
tput sgr 0
if [ ${#PROC} -gt 8 ]; then
	echo -e "\e[1;34m[*] \033[32mToo long  characters You have input...\033[0m"
	echo ""
	echo -e "\033[32mNam Chota Likh De Bhai Mere... less then \033[33m9 \033[32mcharacters Name\033[0m" | pv -qL 10;
	echo ""
	sleep 4
	clear
echo -e "\033[01;32m
...
\033[0m";
	echo ""
	echo -e "\e[1;34m \033[32mNam Chota Likh De Bhai Mere...\033[0m"
	echo ""
else
	ok=1
fi
...
#echo -e '\033[1;43;30m### Made By Himmat Choudhary ### \033[0m';
#echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
echo -e "
...
if [ -d $HOME/.plugins/zsh-syntax-highlighting ];then
	...
	echo -e "\e[1;34m[*] \033[32mLike Kro Follow Kro 🤪 Hope you like my work..\033[0m"
	exit
fi
exit 0
